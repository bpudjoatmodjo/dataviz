...
dim(iris) # nrow0 <- function(x) dim(x)[1]
str(iris) # object
colnames(iris) # x
head(iris) # x
tail(iris) # virginica
...
typeof(iris$Species)
class(iris$Species) # class(x) 
length(iris$Petal.Width) # x
...
1. memilih kolom year, minth, wind dan presure dari dataset storms
2. memilih baris dengan tahun antara 2000 hinga 2015
3. megubah nilai kolom month yang semula angka jadi nama bulan
4. melakukan grouping base on kolom month
5. menghitung rata-rata kece.angin dan tekanan udara
